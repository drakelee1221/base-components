...
public class ExcelUtil {
   ...
   * @param out 输出流
   *//*
  public static void exportExcel(String title, Map<String, String> headMap, ArrayNode jsonArray, String datePattern,
    ...
    workbook.getDocumentSummaryInformation().setCompany("重庆优纳科技有限公司");
    ...
    for (int x =0;x<jsonArray.size();x++) {
      ObjectNode jsonNode = (ObjectNode) jsonArray.get(x);
      ...
      for (int i = 0; i < properties.length; i++) {
        ...
        Object o = jsonNode.get(properties[i]);
        String cellValue = "";
        if (o == null) {
          cellValue = "";
        }else {
...
*/
   ...
   * @param out 输出流
   */
  public static void exportExcelX(String title, Map<String, String> headMap, ArrayNode jsonArray, String datePattern,
    int colWidth, OutputStream out) {
    if (datePattern == null) {
      datePattern = DEFAULT_DATE_PATTERN;
    }
    ...
    for (int x=0;x<jsonArray.size();x++) {
      ...
      for (int i = 0; i < properties.length; i++) {
        ...
        JsonNode o = jsonNode.get(properties[i]);
        String cellValue ;
        if (o == null) {
          cellValue = "";
        }else {
  ...
  public static void downloadExcelFile(String title,Map<String,String> headMap,ArrayNode ja,HttpServletResponse response){
    try {
